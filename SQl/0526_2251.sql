...
values (foodtruck_no_seq.nextval,'JM', '오늘은 감바사 먹는 날', to_char(to_date('2018.04.18','yyyy.mm.dd')),'춘천 자전거 도로에서 판매하는 아주 맛있는 감바사가 있습니다. 우후 2시~4시 10%할인 행사 있어요~','위도','경도',1);
insert into foodtruck_location(no,user_id, title, opendate, detail, latitude, longtitude, poweryn)
values (foodtruck_no_seq.nextval,'EJ', '피자를 피자', to_char(to_date('2018.05.18','yyyy.mm.dd')),'강원도 횡성 어딘가에서 판매하고 있는 피자집 입니다.','위도','경도',1);
insert into foodtruck_location(no,user_id, title, opendate, detail, latitude, longtitude, poweryn)
values (foodtruck_no_seq.nextval,'SB', '치킨먹 닭', to_char(to_date('2018.05.22','yyyy.mm.dd')),'부산 어딘가에 있는 광안대교 ?? 에 있는 맛집 치킨치킨 gogo','위도','경도',1);
insert into foodtruck_location(no,user_id, title, opendate, detail, latitude, longtitude, poweryn)
values (foodtruck_no_seq.nextval,'MS', '새우니니', to_char(to_date('2018.05.25','yyyy.mm.dd')),'실제상황 입니다. 이렇게 큰 새우, 너 새우니니?','위도','경도',1);
insert into foodtruck_location(no,user_id, title, opendate, detail, latitude, longtitude, poweryn)
values (foodtruck_no_seq.nextval,'jigak', '오징어따리', to_char(to_date('2018.06.02','yyyy.mm.dd')),'오징어다리는 휴게소아닌 피시방 아닌 오징어따리로','위도','경도',1);
