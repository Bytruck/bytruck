				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="formwrite">
							...
							<button class="btn btn-success col-lg-4 col-lg-offset-1" type="submit">등록</button>
							<a href="<%=root%>/brand/notice.jsp"><button class="btn btn-danger col-lg-4 col-lg-offset-1" type="button" id="cancel">취소</button></a>
							</div>
						</form>
					</div>
				</div>
