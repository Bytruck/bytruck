			...
			<div class="container">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h2 class="panel-title section-heading no-margin">이벤트 등록</h2>
					</div>
					<div class="panel-body">
						<form class="formwrite" action="<%=root%>/eventwrite.bt"
							...
							<div
								...
								<button class="btn btn-success col-lg-4 col-lg-offset-1"
									id="eventregister" type="submit">등록</button>
